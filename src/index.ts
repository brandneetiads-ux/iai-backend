...
// Supports multiple comma-separated origins in FRONTEND_URL (e.g. both the
// bare domain and the www subdomain), so the live site isn't blocked by CORS
// no matter which one a visitor uses. Falls back to localhost for local dev.
